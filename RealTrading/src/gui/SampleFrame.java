...
//	private NewTradingEngine te_new= new NewTradingEngine(this);
    ...
    public OrderDlg        m_orderDlg = new OrderDlg( this);
...
//    private ScannerDlg      m_scannerDlg = new ScannerDlg(this);
    ...
    Contract con_tract = new Contract();
    String faGroupXML ;
    ...
    public SampleFrame() {
    	...
    	this.con_tract.m_currency ="USD";
        this.con_tract.m_exchange = "SMART";
        this.con_tract.m_symbol = "GOOG";
        this.con_tract.m_secType = "STK";
        ...
        JScrollPane jsp = new JScrollPane(scrollingWindowDisplayPanel);
        JPanel buttonPanel = createButtonPanel();

        getContentPane().add( jsp, BorderLayout.CENTER);
        getContentPane().add( buttonPanel, BorderLayout.EAST);
        setSize( 600, 700);
        setTitle( "Sample Main Page ?");
	...
	void onConnect() {
        ...
        m_client.eConnect( this.m_retIpAddress, this.m_retPort, this.m_retClientId);
    ...
    void onReqMktData() {
        ...
        m_orderDlg.m_rc = true;
//        
////        String genericTicks = "";
////        boolean snapshotOfMktData = true;
////        
//        orderIdNow++;
////        
//        this.con_tract.m_currency ="USD";
...
////
////        // req mkt data
////        m_client.reqMktData( orderIdNow, this.con_tract,
////        		genericTicks, snapshotOfMktData);
//        
//        
//	int x = 0;
//	 	
...
//	 		System.out.println(this.getPrices().get(i));
//	 	}
//	 	System.out.println("OOOOO2");
//        te_new = new NewTradingEngine(this);
//        te_new.startThisSucker();
    ...
    void onReqRealTimeBars() {
        ...
        orderIdNow++;
        // req mkt data
        m_client.reqRealTimeBars( orderIdNow, this.con_tract,
    ...
    void onHistoricalData() {
        ...
        if( Util.StringCompare( m_orderDlg.m_whatToShow, "estimates" ) == 0 ||
        	...
        	m_client.reqFundamentalData(m_orderDlg.m_id, this.con_tract,
        			/* reportType */ m_orderDlg.m_whatToShow);
        	return;
        }

        // req historical data
        m_client.reqHistoricalData(   orderIdNow,this.con_tract,
    ...
    void onReqContractData() {
        ...
        // req mkt data
        m_client.reqContractDetails( orderIdNow, this.con_tract );
    }
...
//        depthDialog.setVisible(true);
    ...
    void placeOrder(boolean whatIf) {
        ...
        // place order
        m_client.placeOrder( m_orderDlg.m_id, this.con_tract, order );
    ...
    void onExerciseOptions() {
        ...
        // cancel order
//        m_client.exerciseOptions( m_orderDlg.m_id, this.con_tract,
...
//                m_orderDlg.m_order.m_lmtPrice, m_orderDlg.m_order.m_auxPrice);
    ...
    public void tickPrice( int tickerId, int field, double price, int canAutoExecute) {
        // received price tick
		//this.te_new.getPrices().add(price);
	//	this.te_new.printSomeShit(price);
