...
//        System.out.println(call2(S, X, r, sigma, T));
        ...
        for(int i = 0; i < 1000; i++){
        	...
        	priceMC1 = callPrice(priceMC1, X, r, sigma, T);
        	System.out.println("Monte Carlo1 price: " + priceMC1);
        	
        	priceBS = callPrice(priceBS, X, r, sigma, T);
        	System.out.println("Black Scholes price: " + priceBS);
        }
    }
}
